...
# Pb avec anagrammes / FrenchLexiconProject-words
dataset_ids <- c('Lexique383','AoA_FreqSub_1493','AoA_FamConcept_1225','Assoc_520','Assoc_366','Concr_ContextAv_ValEmo_Arous_1659','Concr_Imag_FreqSub_Valemo_866',
                  'FrenchLexiconProject-words','FreqSub_Adulte_Senior_660','FreqSub_Imag_1916','FreqSub_Imag_3600','Img_AoA_..._400','Imag_1493','Megalex-visual',
                  'Megalex-auditory','SUBTLEX-US','Aoa32lang',
                  'FrenchLexiconProject-words','RT_LD_NMG_FLP_Mono_1482','SensoryExp_1659','SensoryExp_1659',
                  'ValEmo_Arous_Imag_835','ValEmo_Arous_1286','Manulex',
                  'Valemo_Enfants_600','Valemo_Adultes_604', 'Voisins','WorldLex-English','WorldLex-French')
                 
datasets <- list()
# ex_filenames_ds dictionnaire associe le nom du json et du rds
