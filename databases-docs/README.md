...
Many of these databases can also be explored or queried on-line at <http://www.lexique.org/shiny/openlexique>, with shiny apps from the [openlexicon project](http://github.com/chrplr/openlexicon).
