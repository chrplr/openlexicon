...
1.  Create a folder for it and add the relevant files (csv, tcsv, xlsx,
    zip, ...)
2.  Add some documentation (at a minimum a README.md file) describing
    the database to
    <http://github.com/chrplr/openlexicon/databases-docs>
3.  Optionnaly, if you want to make the database accessible by
    openlexique:
    ...
    -   Modify the [openlexicon
        ...
        this database, and run `git pull` to update the openlexicon
        repository on the server (currently in \~chrplr/shiny-server).
